...
fruit_choice_response1 = pandas.json_normalize(fruit_choice_response.json())
...
streamlit.text(fruit_choice_response1.json())
streamlit.dataframe(fruit_choice_response1)
